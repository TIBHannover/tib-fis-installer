...
<#if (isAuthor || isInvestigator)>
    ...
    <#assign standardVisualizationURLRoot ="/visualization">
        ...
        <#if isAuthor>
            ...
            <svg width="100%" id="publicationsChart" onload="renderPublicationsChart()" onresize="renderPublicationsChart()" style="padding-bottom: 70%; height: 1px; overflow: visible">
            </svg>
